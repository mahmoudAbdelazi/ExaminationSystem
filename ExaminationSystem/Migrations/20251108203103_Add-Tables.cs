    ...
    public partial class AddTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCourseRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentCourseRequests_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentCourseRequests_Users_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentCourseRequests_CourseId",
                table: "StudentCourseRequests",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentCourseRequests_StudentId",
                table: "StudentCourseRequests",
                column: "StudentId");
